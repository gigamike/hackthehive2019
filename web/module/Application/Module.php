    ...
    if ($e->getRequest() instanceof HttpRequest) {
      $application->getEventManager()->attach(
        ...
        function($e) {
          ...
          if (substr($routeMatch->getMatchedRouteName(), 0, 7) == 'member') {
            $controller->layout('layout/member-layout');
          }
          ...
          $viewModel->setVariable('currentCountryCode', $countryCode);
      ...
      $serviceLastLogin = $sm->get('ServiceLastLogin');
      $serviceLastLogin->setLastLogin();

    ...
    'router' => array(
        'routes' => array(
            ...
            'community' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/community[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                    ...
                    'defaults' => array(
                      'controller' => 'User\Controller\Community',
                      'action'     => 'index',
                    ),
                ),
            ),
            'volunteer' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/volunteer[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
    ...
    'console' => array(
        'router' => array(
            'routes' => array(
              ...
              'cron-free-bee-api-test' => array(
                'options' => array(
                  'route' => 'cron-free-bee-api-test',
                  'defaults' => array(
                    'controller' => 'Cron\Controller\FreeBeeApi',
                    'action' => 'index'
                  ),
                ),
              ),

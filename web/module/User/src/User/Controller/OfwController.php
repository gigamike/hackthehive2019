...
class OfwController extends AbstractActionController
{
    ...
    public function indexAction()
    {
      ...
      $paginator = $this->getUserMapper()->getOfws(true, $filter, $order);
    ...
    public function searchAction()
    {
      ...
      if ($request->isPost()) {
        ...
        if (!empty($search_data)) {
          ...
          return $this->redirect()->toRoute('ofw', array('action' => 'index', 'search_by' => $search_by));
        }else{
          return $this->redirect()->toRoute('ofw', array('action' => 'index',));
        }
      }else{
        return $this->redirect()->toRoute('ofw', array('action' => 'index',));
      }

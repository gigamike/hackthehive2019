...
use User\Form\RegistrationOfwFilter;

class RegistrationOfwForm extends Form
{
	public function __construct($dbAdapter, $countryMapper)
	{
		parent::__construct('registration');
		$this->setAttribute('method', 'post');
		$this->setInputFilter(new RegistrationOfwFilter($dbAdapter));
